homepage <- tabItem(tabName = "home", tabsetPanel(tabPanel("Intro", 
                                                           HTML(
                                                             "<h3 align = 'center'><b> Welcome to the ABPEPserver! </h3></b><br>
	       <div>
	       Cancer cells experience tryptophan shortage as a consequence of interferon-gamma (IFN) signaling pathway. It has been recently demonstrated that such tryptophan shortage leads to tryptophan to phenylalanine codon reassignment (W>F) resulting into aberrant peptide product. <br>
        ...
        and often their appearance was associated with T-cell and oncogenic signaling activities.<br>
	       ...
	       Proteomic cancer data from multiple cancer types, hosted by <a href='https://proteomic.datacommons.cancer.gov/pdc/'>PDC commons</a> database, have been used in this analysis. 
	       An in depth description of how the analysis was conducted is shown in the '<b>Methods</b>' tab.
           ...
           enzyme expression in cancer cells. IDO1 stimulates pathways that subvert T-cell immunity while also breaking down tryptophan in its process, leading to a tryptophan deficiency.<sup>1</sup>
            When a healthy cell is deficient in tryptophan, ribosomes will stop translation at the codon for tryptophan. Therefore, protein synthesis will stop. 
           Nevertheless, in Melanoma cells protein synthesis continues despite interferon gamma (IFNγ)-mediated tryptophan depletion. They skip the first 
           nucleotide of the codon for tryptophan. Consequently, the whole reading frame jumps from that point on leading to the synthesis of aberrant proteins as a result 
           of ribosomal frameshifting at tryptophan codons. <sup>2</sup><br>
           
            In follow up studies, it was shown that IFNγ-mediated tryptophan shortage also impacts protein quality by generating specific mis-incorporations of phenylalanine at tryptophan codons.
           This type of amino acid deprivation-induced codon reassignments are called ‘substitutants’ to distinguish them from somatic genetic substitutions.
           Therefore, the absence of the essential amino acid tryptophan causes ribosomes to induce errors of two-types, i.e, ribosomal frame-shifting and amino-acid substitution. </p>
           </div>
           <img src='subs.png' style='border: 2px solid;' width='350x'/></div><br>
           <h4><b>Notes</h4></b>
            <p>1.   Champagne J, Pataskar A, Blommaert N, et al. Oncogene-dependent sloppiness in mRNA translation [published online ahead of print, 2021 Sep 21]. Mol Cell. 2021;S1097-2765(21)00736-X. doi:10.1016/j.molcel.2021.09.002.<br>
              2.    Bartok, O., Pataskar, A., Nagel, R. et al. Anti-tumour immunity induces aberrant peptide presentation in melanoma. Nature 590, 332–337 (2021). https://doi.org/10.1038/s41586-020-03054-1.
            </p>")),
            tabPanel("Methods", HTML("<div><br>
            <div style='display: flex; align-items: center;'>
            <div>
	       ...
	       <img src='Philosopher_workflow.png' width='350px style='max-width: 100%; height: auto;'/></div>
            ...
            <h4><b>Notes</h4></b>
            <p>1.   da Veiga Leprevost F, Haynes SE, Avtonomov DM, Chang HY, Shanmugam AK, Mellacheruvu D, Kong AT, Nesvizhskii AI. Philosopher: a versatile toolkit for shotgun proteomics data analysis. Nat Methods. 2020 Sep;17(9):869-870. doi: 10.1038/s41592-020-0912-y.<br>
            2.   Kong, A. T., Leprevost, F. V., Avtonomov, D. M., Mellacheruvu, D., & Nesvizhskii, A. I. (2017). MSFragger: ultrafast and comprehensive peptide identification in mass spectrometry–based proteomics. Nature Methods, 14(5), 513-520.<br>
            3.   Keller A, Nesvizhskii A, Kolker E, Aebersold R: Empirical statistical model to estimate the accuracy of peptide identifications made by MS/MS and database search. Analytical Chemistry. 2002, 74: 5383-5392. 10.1021/ac025747h.
            </p><br><br><br>")),
            tabPanel("Cancer types", HTML(
              "<div class='parent'>
